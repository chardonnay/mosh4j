...
*Releases:* link:https://github.com/chardonnay/mosh4j/releases/tag/v2.0.2[v2.0.2] — link:docs/release-notes-2.0.2.adoc[release notes]
...
* *Replay & DoS hardening* — per-direction anti-replay window, bounded zlib decompression, and strict protocol-version checks
...
* link:docs/release-notes-2.0.2.adoc[Release Notes v2.0.2] — latest changes
* link:security_best_practices_report.md[Security Best Practices Report] — security findings and fixes
* link:docs/upstream-mosh-review-2026-06.adoc[Upstream MOSH Review] — wire-compatibility check against upstream mosh
